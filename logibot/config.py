...
def get_user_list(config, key):
    with open("{}/logibot/{}".format(os.getcwd(), config), "r") as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "KingOf_univers"
    SUPPORT_CHAT = "Movies_4you"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1001253661229
