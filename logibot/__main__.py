...
import logibot.modules.sql.users_sql as sql
...
from logibot.modules import ALL_MODULES
from logibot.modules.helper_funcs.chat_status import is_user_admin
from logibot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("logibot.modules." + module_name)
            ...
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="🎥 Sᴇᴛᴜᴘ Tᴜᴛᴏʀɪᴀʟ", callback_data="logi_vida")],
               [InlineKeyboardButton(text="➕️ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ➕️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],       
                [InlineKeyboardButton(text="⬅️ Bᴀᴄᴋ", callback_data="logi_"),
                 InlineKeyboardButton(text="➡️", callback_data="logi_helpa")]
              ]
            ),
        )
    elif query.data == "logi_helpa":
        query.message.edit_text(
...
3). Gɪᴠɪɴɢ  Fᴜʟʟ  Pᴇʀᴍɪssɪᴏɴs  Mᴀᴋᴇ  Tɪᴀɴᴀ  Fᴜʟʟʏ  Usᴇғᴜʟ</b>
            ...
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="⬅️", callback_data="logi_help"),
                InlineKeyboardButton(text="➡️", callback_data="logi_helpb")],               
              ]
            ),
        )
    elif query.data == "logi_helpb":
        query.message.edit_text(
            text="""*Cᴏɴɢʀᴀɢᴜʟᴀᴛɪᴏɴs,  Tʜɪꜱ  Bᴏᴛ  Nᴏᴡ  Rᴇᴀᴅʏ  Tᴏ  Mᴀɴᴀɢᴇ  Yᴏᴜʀ  Gʀᴏᴜᴘ

Hᴇʀᴇ  Aʀᴇ  Sᴏᴍᴇ  Essᴇɴᴛɪᴀʟᴛ  Tᴏ  Tʀʏ  Oɴ LOGI.
...
Rᴇғᴇʀ  Hᴇʟᴘ  Mᴇɴᴜ  Tᴏ  Sᴇᴇ  Eᴠᴇʀʏᴛʜɪɴɢ  Iɴ  Dᴇᴛᴀɪʟ*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="logi_helpa"),
                 InlineKeyboardButton(text="➡️", callback_data="logi_helpc")]
                ]
            ),
        )
    elif query.data == "logi_helpc":
        query.message.edit_text(
            text="""*× Fɪʟᴛᴇʀs
...
ᴀɴᴅ  ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ  ᴏᴘᴇɴɴᴇᴅ  ᴀᴛ  6ᴀᴍ(ɪsᴛ)  ᴛᴏ  ᴘʀᴇᴠᴇɴᴛ  ɴɪɢʜᴛ  sᴘᴀᴍs.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="logi_helpc"),
                 InlineKeyboardButton(text="➡️", callback_data="logi_helpe")]
                ]
            ),
        )
...
- Its coded by @cl_me_logesh .so any quire contact me
...
× Bʏ  Usɪɴɢ  Tʜɪꜱ  Bᴏᴛ  Yᴏᴜ  Aʀᴇ  Aɢʀᴇᴇᴅ  Tᴏ  Oᴜʀ  Tᴇʀᴍs  &  Cᴏɴᴅɪᴛɪᴏɴs*""",
    ...
    elif query.data == "logi_musica":
        query.message.edit_text(
            text="""✗*Here is the help for Play Commands*:

*Note*: @nopita_music_bot  works on a single merged commands for Music and Video
...
/playplaylist 
- Start playing Your Saved Playlist on LOGI Servers.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="⬅️ Bᴀᴄᴋ", callback_data="logi_music")]]
            ),
        )
...
LOGI has a additional feature for non-admin users who want to use admin commands
...
/sudolist 
- Check Sudo Users of Nobita Music Bot
...
- When enabled, Tiana will be deleting her 3rd last message to keep your chat clean.""",
        ...
        query.message.edit_text(
            text=f"""{BOT_NAME} it's online since 12/02/2004 and it's constantly updated!
...
• [Click here](https://t.me/{SUPPORT_CHAT}) For Movie Request .
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
    ...
    elif query.data == "logi_tools":
        query.message.edit_text(
            text="""*Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Tʜᴇ Tᴏᴏʟs Mᴏᴅᴜʟᴇ:
Wᴇ Pʀᴏᴍɪsᴇ Tᴏ Kᴇᴇᴘ Yᴏᴜ Lᴀᴛᴇsᴛ Uᴘ-ᴅᴀᴛᴇ Wɪᴛʜ Tʜᴇ Lᴀᴛᴇsᴛ Tᴇᴄʜɴᴏʟᴏɢʏ Oɴ Tᴇʟᴇɢʀᴀᴍ. 
Wᴇ Uᴘᴅʀᴀᴅɢᴇ Eᴠᴇʀʏᴅᴀʏ Tᴏ Sɪᴍᴘʟɪғɪᴇ Usᴇ Oғ Tᴇʟᴇɢʀᴀᴍ Aɴᴅ Gɪᴠᴇ A Bᴇᴛᴛᴇʀ Exᴘʀɪɴᴄᴇ Tᴏ Usᴇʀs.

Cʟɪᴄᴋ Oɴ Bᴇʟʟᴏᴡ Bᴜᴛᴛᴏɴs Aɴᴅ Cʜᴇᴄᴋ Aᴍᴀᴢɪɴɢ Tᴏᴏʟs Fᴏʀ Usᴇʀs.*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
- /karma: Chek karma list of top 10 users""",
 ...
 ❍ /txt :Get Telegraph Link of Replied Text""",
        ...
        query.message.edit_text(
            text="""*LOGIBOT is Now Open Source Bot Project.*
    ...
    if query.data == "about_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 [
                     InlineKeyboardButton(text="💁‍♂️ Iɴғᴏ", callback_data="logi_about"),
                     InlineKeyboardButton(text="😋 Sᴏʀᴄᴇ Cᴏᴅᴇ", callback_data="logi_source"),
                 ],
                 [  
                    InlineKeyboardButton(text="🛡️ Sᴜᴘᴘᴏʀᴛ", callback_data="logi_support"),
                    InlineKeyboardButton(text="👑 Oᴡɴᴇʀ", url=f"t.me/{OWNER_USERNAME}"),
                 ],
                 [
                     InlineKeyboardButton(text="🕊.Dᴇᴠᴇʟᴏᴘᴇʀ", url=f"t.me/KingOf_univers"),
                 ],
                 [
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("LOGIBOT = Started Successfully")
